...
async def _recommend_omdb(phrases: List[str], limit: int) -> List[Dict[str, Any]]:
...
async def recommend_movies(mood: str, limit: int = 5) -> List[Dict[str, Any]]:
	phrases = _mood_phrases(mood)
	return await _recommend_omdb(phrases, limit)
