...
async def test_keyword_strategy(monkeypatch):
	...
	# search
	respx.get("https://www.omdbapi.com/", params={"apikey": "dummy", "s": "tense horror", "type": "movie", "page": 1}).mock(
	...
	# detail
	respx.get("https://www.omdbapi.com/", params={"apikey": "dummy", "i": "tt1111111", "plot": "short"}).mock(
		return_value=httpx.Response(200, json={
			"Title": "Tense Night",
			"Plot": "Very tense.",
...
async def test_embedding_strategy(monkeypatch):
	monkeypatch.setenv("OMDB_API_KEY", "dummy")
	# search
	respx.get("https://www.omdbapi.com/", params={"apikey": "dummy", "s": "paranormal horror", "type": "movie", "page": 1}).mock(
		return_value=httpx.Response(200, json={
			"Search": [
	...
	# detail
	respx.get("https://www.omdbapi.com/", params={"apikey": "dummy", "i": "tt2222222", "plot": "short"}).mock(
		return_value=httpx.Response(200, json={
			"Title": "Ghost House",
